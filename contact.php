            ...
            <section >
                <form method="post">
                  <div class="form-group">
                    ...
                    <input name="name" type="text" pattern="^[a-zA-Z]+\s?[a-zA-Z]{1,20}" class="form-control" title="Only Alphbets are allowed with 1 space not in start and max lenght of Username is 20" id="exampleInputName1" placeholder="Enter your Name here" />
                  ...
                  <div class="form-group">
                    ...
                    <input name="subject" pattern="^[a-zA-Z]+\s?[a-zA-Z]{1,20}"  type="text" class="form-control" title="Only Alphbets are allowed with 1 space not in start and max lenght of Username is 20" id="exampleInputSubject1" placeholder="Enter the Subject here"/>
